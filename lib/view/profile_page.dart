...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    final feedController = context.watch<FeedController>(); // Mengakses controller
    final authController = context.watch<AuthController>(); // Mengakses controller
    final homeController = context.watch<HomeController>(); // Mengakses controller
            ...
            ElevatedButton(onPressed: (){
              authController.login(User(
                ...
                profileImage: Profile(
                  small : 'https://images.pexels.com/photos/27545223/pexels-photo-27545223/free-photo-of-model-in-sweater-lying-on-grass.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',  ), twitterUsername: 'anabda', location: '', updatedAt: null,),);
            }, child: Text('Login'),
  ...
  Column _buildProfileWidget(FeedController feedController, HomeController homeController, AuthController authController) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
